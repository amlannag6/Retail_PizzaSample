...
<html>
	...
	<body>
						...
						document.write('<form action = "#" method = "post">');
							...
							document.write('<strong>Pizza Size :</strong><br>');
								document.write('<select name="pSelect'+i+'" class = "menuSelect">');
									...
									document.write('<option value="Medium">Medium (12 " / 30 cm)  (+ CAD 2.00/Pizza)</option>');
									document.write('<option value="Large">Large (14 " / 35 cm)  (+ CAD 4.00/Pizza)</option>');
								document.write('</select><br><br>');
							...
							document.write('<strong>Extra Cheese :</strong><br>');
								document.write('<select name="eCheeze'+i+'" class = "menuSelect">');
									...
									document.write('<option value="Yes">Yes (+ CAD 0.50/Pizza)</option>');
								document.write('</select><br><br>');
		...
		<div class = "#">
			...
			<a href = "https://www.linkedin.com/"><img src = "../resources/social/linkedin.png" class = "social" /></a> &nbsp;
			<a href = "https://myaccount.google.com/"><img src = "../resources/social/googleplus.png" class = "social" /></a> &nbsp;
