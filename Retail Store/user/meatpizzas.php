      ...
      <div class="website-body">
        ...
        <section class="items">
          <div class="items-body">
            <h3 class="heading text-capitalize mb-md-5 mb-4">Meat Pizzas <span></span></h3>
            <div class="row">
              <?php
              //List products from database
              $results = $mysqli_conn->query("SELECT product_name, product_desc, product_code, product_image, product_price FROM products_list where groupdata = 'Meat Pizzas'");
              if (!$results){
                printf("Error: %s\n", $mysqli_conn->error);
                exit;
              }
